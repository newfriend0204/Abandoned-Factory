...
public class InputSettingsManager : MonoBehaviour {
    ...
    //  Runtime용 Helper 함수들
    // ---------------------------
    public KeyCode GetPrimaryKey(string actionId) {
        KeyBinding b = GetBinding(actionId);
        if (b == null) {
            return KeyCode.None;
        }
        return b.primary;
    ...
    public KeyCode GetSecondaryKey(string actionId) {
        KeyBinding b = GetBinding(actionId);
        if (b == null) {
            return KeyCode.None;
        }
    ...
    public bool GetKey(string actionId) {
        KeyBinding b = GetBinding(actionId);
        if (b == null)
            return false;

        if (b.primary != KeyCode.None && Input.GetKey(b.primary))
            return true;

        if (b.secondary != KeyCode.None && Input.GetKey(b.secondary))
            return true;
    ...
    public bool GetKeyDown(string actionId) {
        ...
        if (b.primary != KeyCode.None && Input.GetKeyDown(b.primary))
            return true;

        if (b.secondary != KeyCode.None && Input.GetKeyDown(b.secondary))
            return true;
    ...
    public bool GetKeyUp(string actionId) {
        ...
        if (b.primary != KeyCode.None && Input.GetKeyUp(b.primary))
            return true;

        if (b.secondary != KeyCode.None && Input.GetKeyUp(b.secondary))
            return true;
