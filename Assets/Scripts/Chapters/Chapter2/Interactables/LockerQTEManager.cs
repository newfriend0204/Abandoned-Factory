...
public class LockerQTEManager : MonoBehaviour {
    ...
    [SerializeField] private List<LocalizedString> monsterLeaveMonologues = new List<LocalizedString>();
    ...
    public void PlayRandomLeaveMonologue() {
        ...
        for (int i = 0; i < monsterLeaveMonologues.Count; i++) {
            if (!string.IsNullOrEmpty(monsterLeaveMonologues[i].GetLocalizedString()))
                candidates.Add(monsterLeaveMonologues[i].GetLocalizedString());
        }
